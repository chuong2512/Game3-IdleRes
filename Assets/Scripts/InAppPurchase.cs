...
public class InAppPurchase : MonoBehaviour, IStoreListener
{
    ...
    private void InitializePurchasing()
    {
        ...
        ConfigurationBuilder configurationBuilder =
            ConfigurationBuilder.Instance(StandardPurchasingModule.Instance(), new IPurchasingModule[0]);
    ...
    public string GetLocalizePrice(int index)
    {
        return (!this.IsInitialized())
            ...
            : InAppPurchase.storeController.products.WithID(this.products[index].googlePlayID).metadata
