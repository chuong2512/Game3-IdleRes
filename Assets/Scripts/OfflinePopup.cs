...
{
    [SerializeField] private Text offlineCash;

    [SerializeField] private Text rewardedCash;
    ...
    [SerializeField] private Transform targetCoinLabel;
    ...
    private void Show()
    {
        ...
        int num2 = (!Singleton<DataManager>.Instance.database.nonConsume.Contains("offlinepack"))
            ? 1
            : this.config.boost.offlineBoostEffective;
