...
public class WaiterController : MonoBehaviour
{
    ...
    private sealed class _Transport_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                case 0u:
                    ...
                    this._this.ApplyAnimationSpeed(2,
                        this._this.restaurantController.boostController.walkingSpeedBoost);
                ...
                case 2u:
                    ...
                    {
                        this._this.totalCashTransfer =
                            ((this._this.cashAfterTransfer <=
                              this._this.restaurantController.restaurantProperties.loadPerWaiter *
                              (double) this._this.restaurantController.boostController.loadExpansionBoost)
                                ? this._this.cashAfterTransfer
                                : (this._this.restaurantController.restaurantProperties.loadPerWaiter *
                                   (double) this._this.restaurantController.boostController.loadExpansionBoost));
                        this._this.elevatorController.SetCash(-this._this.totalCashTransfer);
                        this._this.cashText.gameObject.SetActive(true);
                        GameUtilities.String.ToText(this._this.cashText,
                            GameUtilities.Currencies.Convert(this._this.totalCashTransfer));
                    }
                ...
                case 3u:
                    ...
                    {
                        this._this.myselfTransform.localPosition = Vector3.MoveTowards(
                            this._this.myselfTransform.localPosition, this._this.gatheringPoint,
                            Time.deltaTime * this._this.walkingSpeed);
                        this._current = null;
                        if (!this._disposing)
                        {
                            this._PC = 3;
                    ...
                    {
                        this._this.ApplyAnimationSpeed(1, 1f);
                        this._current = new WaitForSeconds((float) (this._this.totalCashTransfer /
                                                                    (this._this.restaurantController
                                                                         .restaurantProperties.loadingSpeed *
                                                                     (double) this._this.restaurantController
                ...
                case 5u:
                    ...
                    this._this.myselfTransform.localPosition = Vector3.MoveTowards(
                        this._this.myselfTransform.localPosition, this._this.restingPosition,
                        Time.deltaTime * this._this.walkingSpeed);
                    this._current = null;
                    if (!this._disposing)
                    {
            ...
            if (this._this.cashBeforeTransfer > 0.0)
            {
                this._this.elevatorController.Process(1);
                this._this.ApplyAnimationSpeed(1, 1f);
                this._this.loadingTime =
                    ((this._this.cashBeforeTransfer >
                      this._this.restaurantController.restaurantProperties.loadPerWaiter *
                      (double) this._this.restaurantController.boostController.loadExpansionBoost)
                        ? ((float) (this._this.restaurantController.restaurantProperties.loadPerWaiter *
                                    (double) this._this.restaurantController.boostController.loadExpansionBoost /
                                    (this._this.restaurantController.restaurantProperties.loadingSpeed *
                                     (double) this._this.restaurantController.boostController.loadingSpeedBoost)))
                        : ((float) (this._this.cashBeforeTransfer /
                                    (this._this.restaurantController.restaurantProperties.loadingSpeed *
                                     (double) this._this.restaurantController.boostController.loadingSpeedBoost))));
            ...
            IL_383:
            this._this.ApplyAnimationSpeed((this._this.totalCashTransfer <= 0.0) ? 5 : 3,
                this._this.restaurantController.boostController.walkingSpeedBoost);
            goto IL_456;
            IL_547:
            this._this.ApplyAnimationSpeed(5, this._this.restaurantController.boostController.walkingSpeedBoost);
            goto IL_5F7;
            ...
            if (this._this.totalCashTransfer > 0.0)
            {
                this._this.ApplyAnimationSpeed(1, 1f);
                this._current = new WaitForSeconds((float) (this._this.totalCashTransfer /
                                                            (this._this.restaurantController.restaurantProperties
                                                                 .loadingSpeed *
                                                             (double) this._this.restaurantController.boostController
                                                                 .loadingSpeedBoost)));
                if (!this._disposing)
                {
                    this._PC = 4;
    ...
    {
        WaiterController._Transport_c__Iterator0
            _Transport_c__Iterator = new WaiterController._Transport_c__Iterator0();
    ...
    private void Rotate(bool b = true)
    {
